...
if (isComplete) {
    ...
    btn_green.innerHTML = '<p><i class="fa-solid fa-book-open"></i> Belum Selesai</p>';
    ...
    btn_red.innerHTML = '<p><i class="fa-regular fa-trash-can"></i> Hapus </p>';
    btn_red.classList.add("red");
    btn_red.addEventListener("click", function() {
        swal({
            title: "Anda Yakin Ingin Menghapus Buku " + title + "?",
            icon: "warning",
            buttons: ["Batal", "Ya"],
            dangerMode: true,
        })
